...
export default function Hero() {
  ...
  return (
    <section id="home" className="bg-stellas-teal text-white pt-24 pb-16 relative overflow-hidden">
      <div className="absolute inset-0 bg-stellas-teal opacity-20"></div>
